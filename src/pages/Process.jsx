        ...
        <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          <div class="text-center">
            ...
            <p
              ...
              data-aos="fade-left"
            >
              Transforming every stage, from support to sales, onboarding to
              service, with a relentless focus on user-centricity, <br />
              ensuring top-notch quality and delivering exceptional results.
            </p>
          </div>
          ...
          <div class="grid grid-cols-1 mt-10 text-center sm:mt-16 sm:grid-cols-2 sm:gap-x-12 gap-y-12 md:grid-cols-3 md:gap-0 xl:mt-24">
            <div class="md:p-8 lg:p-14" data-aos="fade-right">
              ...
              <p class="mt-5 text-base text-gray-600 font-pj">
                Our support team will be available for 24*7
              </p>
            </div>

            <div
              class="md:p-8 lg:p-14 md:border-l md:border-gray-200"
              data-aos="zoom-in"
            >
              {/* biome-ignore lint/a11y/noSvgWithoutTitle: <explanation> */}
              <svg
              ...
              <p class="mt-5 text-base text-gray-600 font-pj">
                Revolutionize your sales experience with our customer-centric
            ...
            >
              ...
              <p class="mt-5 text-base text-gray-600 font-pj">
                Elevate your journey from sign-up to success with our seamless
                onboarding process.
              </p>
            </div>

            <div
              class="md:p-8 lg:p-14 md:border-t md:border-gray-200"
              data-aos="fade-right"
            >
              {/* biome-ignore lint/a11y/noSvgWithoutTitle: <explanation> */}
              <svg
              ...
              <p class="mt-5 text-base text-gray-600 font-pj">
                Transform your business with premium services tailored to drive
                growth and success.
              </p>
            </div>
            ...
            >
              ...
              <p class="mt-5 text-base text-gray-600 font-pj">
                Boost your business with top-notch quality that sets you apart
            ...
            >
              ...
              <p class="mt-5 text-base text-gray-600 font-pj">
                Get measurable results that drive growth and success for your
                business through our strategic advertising services.
              </p>
            </div>
          </div>
        </div>
